...
fio --name=par --directory=/h7/dug/IT/adm_irfant/benchmark/io/layout_file --rw=write --bs=1m --size=8g --numjobs=16 --end_fsync=1 --refill_buffers --group_reporting --output=/h7/dug/IT/adm_irfant/benchmark/io/logs/${HOSTNAME}-num16-default.fio
```